...
const policies = [
  ...
  },
  {
    ...
    items: [
      "Profit-sharing / performance fee is charged only on eligible profit generated by closed profitable trades executed through Lunar Wolf EA / copy-trading activity. The fee is not charged on deposits, withdrawals, account balance, unused capital, losing trades, broker swap, or broker commission. Once a performance fee has been charged for a completed settlement period, it is non-refundable regardless of future trading performance or market conditions."
    ]
  },
  {
